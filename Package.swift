...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Synchronization-1.0.0-beta+20230309092859.xcframework.zip",
			checksum: "909c7e047d3085b5e75498c20e44561107de511a4b30a143d958f5d2b769a243"
		)
	]
)