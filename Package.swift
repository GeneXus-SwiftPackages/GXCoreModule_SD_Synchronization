...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Synchronization-2.0.0-beta.20.xcframework.zip",
			checksum: "65f91f05335896e84fe67a22c502f3d1026fffccaa5cf4ce6d1499070170b50e"
		)
	]
)