...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Synchronization-2.2.0-rc.1.xcframework.zip",
			checksum: "4a7d30c8c52315b0b74d44fd1a4330cdf362286856ea92631a710291439149f4"
		)
	]
)