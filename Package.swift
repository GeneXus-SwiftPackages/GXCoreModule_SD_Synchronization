...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Synchronization-1.0.0-beta+20230519182256.xcframework.zip",
			checksum: "0dbd5adcbd5b3f07aebf463bee60377363a43ab675e7d1cc8d23fad4cf0b688d"
		)
	]
)