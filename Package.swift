...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Synchronization-4.0.6.xcframework.zip",
			checksum: "fdc9b87d09f4dab1b3f6f444ccd9f75fb58e9831acf387ced259866b45be67fd"
		)
	]
)