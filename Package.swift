...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Synchronization-2.2.0-beta.17.xcframework.zip",
			checksum: "ac1de8ab3c0e0ec458696c91d2920460f4cb7b0603e9d814e00db8afaae71b24"
		)
	]
)