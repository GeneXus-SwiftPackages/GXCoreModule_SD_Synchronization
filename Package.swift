...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Synchronization-1.1.0-rc.1.xcframework.zip",
			checksum: "8c6d345a33a754d6cfe6a245ca13a44efe5b7ccd70bbb302718f5aa4a6aaf4a3"
		)
	]
)