...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Synchronization-1.3.0-rc.1.xcframework.zip",
			checksum: "8b95d555902c0c89c47554d2a9e0f423f7746d31839d0a78f12de4f705267d62"
		)
	]
)