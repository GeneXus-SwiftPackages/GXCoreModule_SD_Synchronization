...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Synchronization-2.0.0-beta.39.xcframework.zip",
			checksum: "9cfd8752e049b9e32dd10e6929cfe752ebffb746df3750188919e1b7aeb2803c"
		)
	]
)