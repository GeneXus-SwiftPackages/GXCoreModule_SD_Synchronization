...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Synchronization-1.3.0-beta.6.xcframework.zip",
			checksum: "94bd871b920a315e9c1be08afd3f4e647a4344f79b5deb6ea24e55e393cd60bc"
		)
	]
)