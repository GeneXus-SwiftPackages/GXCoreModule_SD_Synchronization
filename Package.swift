...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Synchronization-1.3.0-rc.7.xcframework.zip",
			checksum: "9b510d1e9fdf3712124742d7b32d66d28425fbde0eab175607cd86ad189acea8"
		)
	]
)