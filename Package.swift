...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Synchronization-1.0.0-beta.20230721115743.xcframework.zip",
			checksum: "d964327070abbf16cb97826dd4969a0c1f3bce2d59e848cd904ce6674457a48e"
		)
	]
)