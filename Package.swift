...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Synchronization-3.2.0.xcframework.zip",
			checksum: "28275c8e3e960fcc7be655bed16f5e4b401f07cd750cde0defa38a6e1c793ec6"
		)
	]
)