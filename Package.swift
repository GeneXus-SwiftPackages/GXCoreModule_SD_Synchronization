...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Synchronization",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Synchronization-2.0.0-rc.36.xcframework.zip",
			checksum: "54a2ace8193c3bff156939a55bb08e594edad149ae19b867582af189e4a0a4aa"
		)
	]
)